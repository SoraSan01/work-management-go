document.addEventListener('DOMContentLoaded', function() {
  ...
  const setCreateMode = date => {
    ...
    form.action='/supervisor/events/store';
  ...
  const setViewMode = event => {
    ...
    form.action=`/supervisor/events/update/${event.id}`;
    deleteForm.action=`/supervisor/events/delete/${event.id}`;
